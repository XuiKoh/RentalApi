...
module.exports = {
	FlickrApi:  function(req, res) {
		...
		var url = 'https://api.flickr.com/services/rest/?&method=flickr.photos.search&api_key=5eded44188320998948b9966f4d49e50&text='+ keyword +'&tags='+ tags +'&tag_mode=all&accuracy=1&extras=description&per_page=5000&format=json&nojsoncallback=1';
	...
	FourSquareApi: function (req,res){
		...
		// var url = "https://api.foursquare.com/v2/venues/search?query="+ keyword +"&ll=" + latitude + "," + longitude + "&oauth_token=4FQK1UASUTOC54YC3NVGIQLED3JKXZ3CDG3H2CZYWFSHK1AG&v=20150905";
